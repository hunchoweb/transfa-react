...
export default function AuthConfirmPin({
  originalPin,
  onConfirm,
  onBack,
  isSubmitting = false,
  ...
  const handleConfirm = useCallback(() => {
    ...
    if (fullPin.length === 4) {
      if (fullPin === originalPin && !isSubmitting) {
  ...
  }, [pin, originalPin, isSubmitting, onConfirm]);
      ...
      >
        ...
        >
          ...
          <Animated.View entering={FadeInUp.duration(400).delay(100)} style={styles.titleContainer}>
            ...
            <Text style={styles.instructions}>Re-enter the 4 digit pin you entered initially.</Text>
          </Animated.View>
          ...
          <Animated.View entering={FadeInUp.duration(400).delay(300)}>
            <Pressable
              style={({ pressed }) => [
                ...
                (!isPinComplete || isSubmitting) && styles.buttonDisabled,
                isPinComplete && !isSubmitting && pressed && styles.buttonPressed,
              ]}
